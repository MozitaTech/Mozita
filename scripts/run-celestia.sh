...
#change port 36657 => 8545
CELESTIA_APP_RPC="36657"
CELESTIA_APP_PROXY_APP_PORT="36658"
CELESTIA_APP_GRPC_PORT="1090" #change port 1090 => 9090
DA_GRPC="36650"
...
screen -dmS celestia-test celestia-appd start --grpc.enable --home $APP_PATH --log-to-file mytestnet/celestia-log.txt
